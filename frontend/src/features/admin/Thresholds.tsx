...
const FIELDS: { key: NumericKey; label: string; hint: string; min: number; max: number; step: number }[] = [
  { key: 'pm_rise', label: 'PM2.5 rise (µg/m³ in 2 min)', hint: 'Fire branch. 5 to 200.', min: 5, max: 200, step: 1 },
  ...
  { key: 'hazardous_pm25', label: 'Hazardous SMS threshold (µg/m³)', hint: 'Fan-out to registered phones above this PM2.5.', min: 50, max: 1000, step: 5 },
]
